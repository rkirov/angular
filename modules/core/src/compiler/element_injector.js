...
export class DirectiveBinding extends Binding {
  ...
  static _hasEventEmitterAtDirectiveBinding(eventName: string, binding: DirectiveBinding) {
...
export class ProtoElementInjector  {
  ...
  hasEventEmitter(eventName: string) {
    var p = this;
    if (isPresent(p._binding0) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding0)) return true;
    if (isPresent(p._binding1) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding1)) return true;
    if (isPresent(p._binding2) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding2)) return true;
    if (isPresent(p._binding3) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding3)) return true;
    if (isPresent(p._binding4) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding4)) return true;
    if (isPresent(p._binding5) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding5)) return true;
    if (isPresent(p._binding6) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding6)) return true;
    if (isPresent(p._binding7) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding7)) return true;
    if (isPresent(p._binding8) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding8)) return true;
    if (isPresent(p._binding9) && DirectiveBinding._hasEventEmitterAtDirectiveBinding(eventName, p._binding9)) return true;
    return false;
  }
